...
class AssistantApp {
    ...
    setupStreamListener() {
        ...
        this.unsubscribeStream = window.electronAPI.onStreamChunk((chunk) => {
            if (this.currentStreamingMessage) {
                ...
                if (textElement) {
                    if (chunk.error) {
                        ...
                        textElement.innerHTML = this.formatMarkdown(`❌ Error: ${chunk.error}\n\n` +
                            `**Troubleshooting:**\n` +
    ...
    async handleSubmit() {
        ...
        try {
            ...
            if (textElement) {
                textElement.innerHTML = this.formatMarkdown('❌ Sorry, I encountered an error processing your request. Please try again.');
            }
